...
const Features = () => {
    return (
        <div className="lg:bg-grey-waldo lg:p-16">
            <div className="pt-2 text-blue-waldo">
                <h1 className="text-3xl lg:text-4xl">Hydra Boost Daily Lenses</h1>
                <p className="pt-2 text-sm font-exttrabold lg:w-96 lg:text-base lg:pt-6">Designed for optimum comfort and moisture. Each lens is made from ultra-breathable Etafilcon A with a high water content of 58%.</p>
                <h4 className="pt-2 lg:pt-4">For a limited time only, get a free pair of sunglasses with your contact lens order.</h4>
            </div>
